...
class Ui_stdntreg(QtGui.QWidget):
    ...
    def setupUi(self, stdntreg):
        ...
        self.label.setGeometry(QtCore.QRect(130, 20, 231, 31))
        font = QtGui.QFont()
        ...
        self.lineEdit.setGeometry(QtCore.QRect(220, 80, 201, 21))
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.lineEdit_2 = QtGui.QLineEdit(stdntreg)
        self.lineEdit_2.setGeometry(QtCore.QRect(220, 120, 201, 21))
        self.lineEdit_2.setObjectName(_fromUtf8("lineEdit_2"))
        self.lineEdit_3 = QtGui.QLineEdit(stdntreg)
        self.lineEdit_3.setGeometry(QtCore.QRect(220, 170, 201, 21))
        self.lineEdit_3.setObjectName(_fromUtf8("lineEdit_3"))
        self.lineEdit_4 = QtGui.QLineEdit(stdntreg)
        self.lineEdit_4.setGeometry(QtCore.QRect(220, 210, 201, 21))
    ...
    def retranslateUi(self, stdntreg):
        ...
        self.label.setText(_translate("stdntreg", "STUDENT DETAILS", None))
        ...
        self.label_5.setText(_translate("stdntreg", "AMOUNT:", None))
